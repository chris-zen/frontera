...
def test_request_response_converters():
    ...
    assert frontier_request.meta['scrapy_body'] == 'BodyContent'
    ...
    assert request_converted.body == 'BodyContent'
    ...
    response = ScrapyResponse(url=url, request=request_converted,
                              headers={'TestHeader': 'Test value'})
    frontier_response = rsc.to_frontier(response)
    assert frontier_response.meta['scrapy_body'] == 'BodyContent'
    ...
    assert response_converted.body == 'BodyContent'
